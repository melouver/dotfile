...
(custom-set-faces
 ...
 '(helm-selection ((t (:background "#073642" :foreground "orange" :inverse-video nil :underline t))))
 '(mode-line ((t (:foreground "#F0FFF0" :background "#2075c7" :inverse-video nil))))
 '(mode-line-inactive ((t (:foreground "#2075c7" :background "#F0FFF0" :inverse-video nil))))
 '(powerline-active1 ((t (:foreground "#F0FFF0" :background "#2075c7" :inverse-video nil))))
 '(powerline-active2 ((t (:foreground "#F0FFF0" :background "#2075c7" :inverse-video nil))))
 '(powerline-inactive1 ((t (:foreground "#2075c7" :background "#F0FFF0" :inverse-video nil))))
 '(powerline-inactive2 ((t (:foreground "#2075c7" :background "#F0FFF0" :inverse-video nil)))))
